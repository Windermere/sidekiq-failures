# Sidekiq1::Failures [![Build Status](https://secure.travis-ci.org/mhfs/sidekiq1-failures.png)](http://travis-ci.org/mhfs/sidekiq1-failures)
...
WARNING: by default sidekiq1-failures will keep up to 1000 failures. See [Maximum Tracked Failures](https://github.com/mhfs/sidekiq1-failures#maximum-tracked-failures) below.
...
To avoid this sidekiq1-failures adopts a default of 1000 maximum tracked failures.

To change the maximum amount:

```ruby
Sidekiq1configure_server do |config|
...
Sidekiq1-failures offers three failures tracking options (per worker):
...
[license]: https://github.com/mhfs/sidekiq1-failures/blob/master/LICENSE
