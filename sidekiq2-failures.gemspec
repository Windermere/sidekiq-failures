# -*- encoding: utf-8 -*-
require File.expand_path('../lib/sidekiq2/failures/version', __FILE__)
...
Gem::Specification.new do |gem|
  ...
  gem.homepage      = "https://github.com/mhfs/sidekiq2-failures/"
  gem.license       = "MIT"

  gem.files         = `git ls-files`.split($\)
  gem.executables   = gem.files.grep(%r{^bin/}).map{ |f| File.basename(f) }
  gem.test_files    = gem.files.grep(%r{^(test|spec|features)/})
  gem.name          = "sidekiq2-failures"
  gem.require_paths = ["lib"]
  gem.version       = Sidekiq2::Failures::VERSION

  gem.add_dependency "sidekiq2", ">= 4.0.0"
