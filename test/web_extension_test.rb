...
module Sidekiq2
  describe "WebExtension" do
    ...
    it 'can display home with failures tab' do
      ...
      last_response.body.must_match(/sidekiq2/)
    ...
    def create_sample_failure(data = {})
      ...
      Sidekiq2.redis do |c|
        c.multi do
          c.zadd(Sidekiq2::Failures::LIST_KEY, failure_score, Sidekiq2.dump_json(data))
          c.set("stat:failed", 1)
        end
      end
    end
    ...
    def failed_count
      Sidekiq2.redis { |c| c.get("stat:failed") }
    end
