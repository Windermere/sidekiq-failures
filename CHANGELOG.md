...
## 0.4.0
  ...
  * Explicitly require sidekiq2/api (@krasnoukhov)
...
## 0.3.0
  ...
  * Add `Sidekiq2::Failures.reset_failures` helper method
  * Add `Sidekiq2::Failures.count` helper method (@zanker)
...
## 0.2.0
  ...
  * Handle Sidekiq2::Shutdown exceptions (@krasnoukhov)
...
## 0.1.0
  ...
  * Prevent sidekiq2-failures from loading up sidekiq2/processor (and thus
